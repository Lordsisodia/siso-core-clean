...
export default function ClientQuickSetupPage() {
  ...
  const handleComplete = (data: any) => {
    ...
    if (user) {
      ...
      progress.hasCompletedQuickSetup = true;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-5xl mx-auto">
          <Card className="bg-siso-bg-alt border-siso-border">
            <CardHeader>
              <CardTitle className="text-2xl text-siso-text-bold">Quick Setup</CardTitle>
            </CardHeader>
            <CardContent>
              <QuickSetupFlow 
